...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://youtube.com/@tggamecloud005')
            ],[
            InlineKeyboardButton('🔍 Ongoing Anime', url='https://t.me/Ongoing_Counter'),
            InlineKeyboardButton('🤖 Finished Anime', url='https://t.me/All_Anime_Counter')
            ],[
